<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Admission Visit Services - Utilities Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link @if (!request()->is('staff/admissionvisits*'))
            collapsed
        @endif" href="#" data-toggle="collapse" data-target="#collapseAdmissionVisits"
            aria-expanded="true" aria-controls="collapseAdmissionVisits">
            <i class="fas fa-table"></i>
            <span>Admission Visits</span>
        </a>
        <div id="collapseAdmissionVisits" class="collapse @if(request()->is('staff/admissionvisits*')) show @endif" aria-labelledby="headingUtilities"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Admission Visits </h6>
                <a class="collapse-item" href="{{ route('staff.admissionvisits.index') }}">View All</a>
            </div>
        </div>
    </li>
    @endif
