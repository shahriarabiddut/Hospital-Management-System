                    ...
                    <tbody> 
                        <tr>
                            <th>Admission <span class="text-danger">*</span></th>
                                <td><select required name="admission_id" class="form-control room-list">
                                        <option value="0">Select Patient Admission</option>
                                        @foreach ($admissions as $admission)
                                        <option value="{{ $admission->id }}"> {{ $admission->patient->name }} </option>
                                        @endforeach
                                        </select></td>
                            </tr>
                        <tr>
