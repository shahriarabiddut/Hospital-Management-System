            ...
            <form method="POST" action="{{ route('staff.patient.store') }}" enctype="multipart/form-data">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                   ...
                   <th>Full Name <span class="text-danger">*</span></th>
                    ...
                    <tr><th>Date of Birth <span class="text-danger">*</span></th>
                    ...
                    <th>Gurdian <span class="text-danger">*</span></th>
                        <td><input required name="guardian" type="text" class="form-control"></td>
                    </tr><tr>
                        <th>Prescription</th>
                        <td><input name="prescription" type="file" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>NID</th>
                        <td><input name="nid" type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td colspan="2">
