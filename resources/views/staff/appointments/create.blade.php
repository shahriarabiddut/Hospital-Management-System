...
@section('content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Create Appointment </h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Appointment
            <a href="{{ url('staff/appointpent') }}" class="float-right btn btn-success btn-sm"> <i class="fa fa-arrow-left"></i> View All </a> </h6>
        </div>
        <div class="card-body">
