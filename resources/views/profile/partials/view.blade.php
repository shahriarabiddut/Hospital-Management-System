        ...
        <div class="col-lg-4">
          <div class="card mb-4">
            <div class="card-body text-center">
              ...
              <a href="{{ route('student.profile.cvview') }}"><button type="button" class="btn btn-primary btn-block my-1">Edit CV </button></a>
              <a href="{{ route('cvview',$user->id) }}"><button type="button" class="btn btn-success btn-block  my-1">View CV </button></a>
            </div>
          </div>
