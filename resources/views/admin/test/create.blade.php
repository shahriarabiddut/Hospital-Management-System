                ...
                <form id="myForm" method="POST" action="{{ route('admin.test.store') }}" enctype="multipart/form-data">
                    ...
                    <table id="inputTable" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                      <thead>
                        ...
                        <tr>
                          <th>Fee</th>
                          <td><input required name="price" type="text" class="form-control"></td>
                      </tr>
                      </thead>
                      <tbody></tbody>
                    </table>
                    <button type="button" class="btn btn-block btn-success" onclick="addInput()"> + Add Input Fields</button><button type="submit" class="btn my-1 btn-block btn-primary">Submit</button>
                  </form>
            </div>
        </div>
    </div>
