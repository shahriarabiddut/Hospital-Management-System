            ...
            <form method="POST" action="{{ route('admin.roomtype.update',$data->id) }}" enctype="multipart/form-data">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th>Detail</th>
                        <td>
                        <textarea name="details" id="" cols="30" rows="10"class="form-control">{{ $data->details }}</textarea>
                        </td>
                    </tr><tr>
                        <th>Seat</th>
                        <td><input required name="seat" value="{{ $data->seat }}"  type="number" class="form-control"></td>
                    </tr><tr>
                        <th>Price</th>
                        <td><input required name="price" value="{{ $data->price }}"  type="number" class="form-control"></td>
                    </tr><tr>
                        <td colspan="2">
