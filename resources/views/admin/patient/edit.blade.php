...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="{{ url('admin/patient/'.$data->id) }}" class="float-right btn btn-success btn-sm"> <i class="fa fa-arrow-left"></i> View All </a> </h6>
        </div>
        <div class="card-body">
            
            <div class="table-responsive">
            <form method="POST" action="{{ route('admin.patient.update',$data->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
