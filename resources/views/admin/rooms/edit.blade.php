            ...
            <form method="POST" action="{{ route('admin.rooms.update',$data->id) }}" enctype="multipart/form-data">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th>Floor</th>
                        <td><input required name="floor" value="{{ $data->floor }}" type="text" class="form-control"></td>
                    </tr><tr>
                        <th>Location</th>
                        <td><input required name="location" value="{{ $data->location }}" type="text" class="form-control"></td>
                    </tr><tr>
                        <td colspan="2">
