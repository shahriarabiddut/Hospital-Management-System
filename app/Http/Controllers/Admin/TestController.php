...
class TestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.test.index')->with('success', 'Staff Department Data has been added Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.test.index')->with('success', 'Staff Department Data has been updated Successfully!');
    }
