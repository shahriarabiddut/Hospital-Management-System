...
class SupportController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       return redirect('patient/support')->with('success','Support Ticket has been added Successfully!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if($data->status!=null || $data->status!=0){
            return redirect('patient/support')->with('danger','You cannot delete Support Ticket!');
        }else{
            $data->delete();
            return redirect('patient/support')->with('danger','Support Ticket has been Deleted Successfully!');
        }
